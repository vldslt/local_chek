package com.example.local_chek
...
class MainActivity : AppCompatActivity() {
    ...
    val CITY:String = "izmir,tr"
    val API: String = "dc1409e0a2523a5559474e3cb60b6c9a"
    ...
    inner class wetherTask() : AsyncTask<String, Void, String>()
    {
        ...
        override fun onPostExecute(result: String?) {
            ...
            try {
                ...
                val weather = jsonObj.getJSONArray("weathe").getJSONObject(0)
...
//                val pressure = main.getJSONObject("pressusre")
